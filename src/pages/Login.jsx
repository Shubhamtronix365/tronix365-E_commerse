...
const Login = () => {
    ...
    return (
        <div className="min-h-screen md:h-screen md:overflow-hidden grid grid-cols-1 md:grid-cols-2 bg-tronix-bg relative overflow-hidden">
            ...
            <div className="hidden md:flex flex-col justify-between p-8 lg:p-12 bg-gradient-to-br from-violet-950 via-slate-900 to-black border-r border-white/5 relative overflow-hidden">
                {/* Visual accents */}
            ...
            <div className="flex flex-col justify-center items-center px-6 py-4 md:py-6 bg-tronix-bg relative overflow-y-auto md:h-full">
                {/* Background Glow */}
