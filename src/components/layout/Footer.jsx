                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li><Link to="/about" className="group flex items-center text-gray-400 hover:text-white text-sm transition-colors"><ChevronRight size={16} className="text-tronix-primary opacity-0 group-hover:opacity-100 -ml-4 group-hover:mx-1 transition-all" /> About Us</Link></li>
                            <li><Link to="/shop" className="group flex items-center text-gray-400 hover:text-white text-sm transition-colors"><ChevronRight size={16} className="text-tronix-primary opacity-0 group-hover:opacity-100 -ml-4 group-hover:mx-1 transition-all" /> Shop Products</Link></li>
                            <li><Link to="/blogs" className="group flex items-center text-gray-400 hover:text-white text-sm transition-colors"><ChevronRight size={16} className="text-tronix-primary opacity-0 group-hover:opacity-100 -ml-4 group-hover:mx-1 transition-all" /> Blogs & Guides</Link></li>
                            <li><Link to="/tower-orders" className="group flex items-center text-tronix-accent hover:text-white text-sm transition-colors"><ChevronRight size={16} className="text-tronix-accent opacity-0 group-hover:opacity-100 -ml-4 group-hover:mx-1 transition-all" /> Tower Orders (B2B Factory)</Link></li>
